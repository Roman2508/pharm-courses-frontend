...
export function AsyncSelect<T>({
  ...
  const debouncedSearchTerm = useDebounceValue(searchTerm, preload ? 0 : 300)
    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          aria-expanded={open}
          className={cn(
            "justify-between w-full rounded-xl border-border text-sm whitespace-nowrap shadow-xs",
            "transition-[color,box-shadow] outline-none focus-visible:ring-[3px]",
            "text-text-primary placeholder:text-text-muted cursor-pointer focus:outline-none focus:ring-2",
            "focus:ring-primary focus:border-transparent transition-all border bg-input px-3 py-2 h-12 font-normal",
